...
class Users extends Controller {
	...
	public function eating_journal()
	{
		...
		$this->viewVars['dailytracker']	=$this->journal_model->getFatlossAdvice();		
	...
	function recipe_finder()
	{
		...
		if (@$this->rID)
		{
			$query .= " LEFT JOIN recipe_classification_selections rcX ON rcX.rID=".$this->rID." AND rcX.rcID=rc.rcID";
		}
