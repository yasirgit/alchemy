...
<head>
	...
	<?php 	  
	//if(($this->CI->router->class=="recipefinder")||($this->CI->router->class=="eatingout") || ($this->CI->router->method=="recipe_finder" && $this->CI->router->class=="users"))	
	...
	if($this->CI->router->method=="recipe_finder" && $this->CI->router->class=="users"){
	?>
