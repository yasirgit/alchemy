            ...
            <div class="holder">
                ...
                <div class="lost-wrapper">
                    ...
                    <div id="tab-7"  class="lost-boxes lost-boxes-tab">
                                            	<div class="lost-box-rptr"><h3>You lost<br /><span>0 lbs.</span><br />To Date</h3></div>
                                                <div class="lost-box-rptr length-bg"><h3>You lost <br /><span>0 in.</span><br />To Date</h3></div>
                                                <div class="lost-box-rptr weight-in-percent-bg"><h3>You lost <br /><span>0%</span><br />body fat<br />To Date</h3></div>
                                                <div class="view-all-measure"><a href="#"></a></div>
                    </div>
                    <div id="tab-8" class="lost-boxes lost-boxes-tab">
                                            	<div class="lost-box-rptr"><h3>You lostc <br /><span>0 lbs.</span><br />To Date</h3></div>
                                                <div class="lost-box-rptr length-bg"><h3>You lost <br /><span>0 in.</span><br />To Date</h3></div>
                                                <div class="lost-box-rptr weight-in-percent-bg"><h3>You lost <br /><span>0%</span><br />body fat<br />To Date</h3></div>
                                                <div class="view-all-measure"><a href="#"></a></div>
                     </div>
                                            ...
                                            <div class="grid-holder-bottom">
                                                ...
                                                <div class="grid-tab-wrapper">
                                                	<ul class="grid-tabbing"  id="tabset">
                                                        ...
                                                        <li><a class="tab" href="#tab-23"><span class="up-status">% Body Fat</span></a></li>
                                                        <li><a class="tab" href="#tab-24"><span>Fat Weight</span></a></li>
                                                        <li><a class="tab" href="#tab-25"><span class="up-status">BMI</span></a></li>
                                                    </ul>
...
<!--														<img src="<?=$this->config->item('base_url')?>/htdocs/images/successjournal/myreslut-grid.gif" alt="" />-->
                                                      <div style="float:left;">
														...
														<?php $this->load->view("successjournal/inches_graph") ;?>
														 ...
														 <div id="tab-23" class="graph-replacer" style="display:none;">aaaaa</div>
														 <div id="tab-24" class="graph-replacer" style="display:none;">bbbbbb</div>
														  <div id="tab-25" class="graph-replacer" style="display:none;">ccccc</div>
                                                       <!-- <ul class="period-tabbing" id="tabset">
                                                            <li class="active"><a class="tab" href="#tab-26">All Time</a></li>
                                                            <li><a class="tab" href="#tab-27">This month</a></li>
                                                            <li><a class="tab" href="#tab-28">Last month</a></li>
