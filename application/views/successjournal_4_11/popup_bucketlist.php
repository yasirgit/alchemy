...
?>     
        ...
        <div class="popup-middle">
			...
			<form name="bcklist" method="post" action="successjournal/bucketlistedit">
            ...
            <fieldset class="btn">
            	...
            	<input name="bucketedit" type="image" src="<?=$this->config->item('base_url')?>/htdocs/images/successjournal/btn-save.gif" value="bb" />  
...
?>
        ...
        <div class="popup-middle">
			...
			<form name="bcklist" method="post" action="successjournal/bucketlist">
        	<fieldset id="rtest">
...
<!--<input type="image" src="<?=$this->config->item('base_url')?>/htdocs/images/successjournal/btn-remove.gif" value="" />-->
            ...
            <fieldset class="btn">
            	...
            	<input name="bucketAdd" type="submit" src="<?=$this->config->item('base_url')?>/htdocs/images/successjournal/btn-save.gif" value="submit" />               
           </fieldset>
           </form> 
        </div>
        <div class="bottom">
