...
<div style="float:left;">
	<select name="<?=$day?>[<?=$event?>]" id="<?=$day?>_<?=$event?>">
		<? if (timeRange(@$start,@$end,'24:00')) { ?><option value="24:00:00">12:00 AM</option><?}?>
		<? if (timeRange(@$start,@$end,'24:30')) { ?><option value="24:30:00">12:30 AM</option><?}?>
