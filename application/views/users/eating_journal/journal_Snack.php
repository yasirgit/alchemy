	...
	<div class="schedule-box sub2 meal">
		...
		<div class="holder" <?php if (@$time->journal[0]->planned == 1) { ?>style="background:#E6E6E6;"<?php } ?>>
			...
			<div class="image-box">
				...
				{
					?><img src="htdocs/images/img19.gif" width="107" alt="" /><?php
				}
			...
			<div class="status-box"><?php
				...
				{
				?>
				<img src="htdocs/images/img12.png" class="png" alt="" />
				<?php
				}
				else
				{
				?>
				 <img src="htdocs/images/img14.png" id="errorsnackfat<?php echo $journal_id;?>" class="png" alt="" title="Proplem" />
				<?php
				}
			?></div>
		</div>
...
$fatlossdata['classType']="errorsnackfat".$journal_id;
...
{			
	...
	<div class="schedule-box sub5 meal">
		...
		<div class="holder">
			...
			<div class="image-box"><span id="mealType"><?=$time->type?></span>
			<img src="htdocs/images/img19.gif" width="107" alt="" />
			</div>			
			<div class="block"><div><span>Enter your Snack</span></div>
				<div class="status-box" style="float:right;">
					<img src="htdocs/images/img11.png" width="53" class="png" alt="" />
				</div>
			</div>			
		</div>
	</div>
