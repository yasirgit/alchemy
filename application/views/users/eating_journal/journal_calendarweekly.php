<div class="calendar-user">
	...
	<div class="jump-to-day"><a href="javascript:void(0)" class="quick-jump-link">Jump to A Week</a></div>	
	<div class="clear">&nbsp;</div>
	<span id="jumpexistDate" style="display:none;"><?php echo date("Y-m-d");?></span>
	<div class="jumppicker" id="jumpDateDiv" style="display:none;position:absolute;z-index:32000;padding:5px 0 0 20px;"></div>
</div>