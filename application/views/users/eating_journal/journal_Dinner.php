	...
	<div class="schedule-box sub2 meal">
		...
		<div class="holder" <?php if (@$time->journal[0]->planned == 1) { ?>style="background:#E6E6E6;"<?php } ?>>
			...
			<div class="image-box">
				...
				{
					?><img src="htdocs/images/img21.gif" width="107" height="70" alt="" /><?php
				}
			...
			<div class="status-box"><?php
				...
				{
				?>
				 <img src="htdocs/images/img13.png" id="errordinnerfat<?php echo $journal_id;?>" class="png" alt="" />
				<?php
				}
			?></div>
		</div>
...
$fatlossdata['classType']="errordinnerfat".$journal_id;
...
else
{
	...
	<div class="schedule-box sub5 meal">
		...
		<div class="holder">
			...
			<div class="image-box">
				<span id="mealType"><?=$time->type?></span>
				<img src="htdocs/images/img21.gif" alt="" />
			</div>
