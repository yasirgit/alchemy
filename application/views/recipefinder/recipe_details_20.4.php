...
<div class="how-do-use"><a class="about-page" href="#">How do I use this page</a>
				...
				<div class="recipy-box-left">
					...
					<div class="recipy-left-content">
						<ul class="recipy-add-list">
							...
							<li><a href="#" class="add-eating">Add to Eating Journal</a></li>
							<li><a href="#" class="print-option">Print</a></li>
						</ul>
						...
						?>
							...
							<li class="protien"><a href="#" <?php if($recipe_details['direction']['proteinStatus'] != 'solid'){ ?> class="prot_stripe" <?php }?>>PROTEIN</a></li>
							<?php
							} 
							if($recipe_details['direction']['isSlowcarb'] == 1) {
							?>
							<li class="slow-carb"><a href="#" <?php if($recipe_details['direction']['slowcarbStatus'] == 'solid'){ ?> class="slow-carb" <?php } else { ?> class="slow-carb-stripe" <?php } ?>>slow carb</a></li>
							<?php 
							}
							if($recipe_details['direction']['isFirstcarb'] == 1) {
							?>
							<li class="fast-carb"><a href="#" <?php if($recipe_details['direction']['firstcarbStatus'] == 'solid'){ ?> class="fast-carb" <?php } else { ?> class="fast-carb-stripe" <?php } ?> >FAST carb</a></li>
							<?php
							}
							?>
						</ul>
						...
						<div class="clear-both-side">
							<div class="recipy-thumb-site">
								<div class="recipy-thumb">
									...
									<span class="view-photoss"><a href="#">View photos</a></span>
								</div>
							...
							<div class="ingredients-site">
								...
								<div class="re-user-icon">
									<span class="rec-user-link">by <a href="#"><?php echo $recipe_details['user_name']; ?></a></span>
		...
		<div class="reviews-side">
				...
				<div class="review-content">
					...
					<div class="review-content-rptr review-rptr-even">
						...
						<p>
							...
							<?php
							echo date('d M, y', strtotime($rat_details[$i]->created))." by member: <a href='#'>".$rat_details[$i]->username."</a>";
							?>
							</span>
			...
			<div class="rec-review-list">
				...
				<div class="review-put-area">
					<div class="re-own-diet">Do you think this recipe is good for <a href="#">Ripemedia's own diet?</a></div>
					<div class="re-give-review">
						 <?php
							for($i=0;$i<count($reviews);$i++)	
							{
						    ?>
								...
								?>
								<!-- <br /> -->
								<a href="#"><img src="htdocs/images/img-stars<?php echo $avg;?>.gif" /></a>
						    <?php
							}
						 ?>
						<h4>Review Now </h4>
					...
					<div class="put-rev-form-area">
						<form id="newreview_frm" method="post">
							...
							<textarea name="review_text" id="review_text" rows="6" style="width:350px;">			
							</textarea>
