	...
	plot2 = $.jqplot('chart2', [line2], {
	 ...
	 axes: {
	    xaxis: {
		 ...
		 tickOptions:{fontSize:'8pt', fontFamily:'Tahoma',textColor: '#666666',showLabel:true,showGridline:false,mark: 'outside',showMark: true, angle:-40
},
