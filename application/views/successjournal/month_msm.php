...
if($month_umval){
foreach($month_umval as $month_val)
{
      $thigh = $month_val['um_thighs'];
	  $hip = $month_val['um_hips'];
	  $calf = $month_val['um_calves'];
	  $wrist = $month_val['um_wrist'];
	  $waist = $month_val['um_waist'];
	  $forearms = $month_val['um_forearms'];
	  $weight = $month_val['um_bweight'];
...
if($month_startVal){ 
foreach($month_startVal as $month_stval)
{
     
	 
	  $st_thigh = $month_stval['um_thighs'];
	  $st_hip = $month_stval['um_hips'];
	  $st_calf = $month_stval['um_calves'];
	  $st_wrist = $month_stval['um_wrist'];
	  $st_waist = $month_stval['um_waist'];
	  $st_forearms = $month_stval['um_forearms'];
	  $st_weight = $month_stval['um_bweight'];
