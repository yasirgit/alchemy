...
define('NAVSECTION_FATLOSS_COACH',	    'fatloss_coach');
...
function getRightNavbar($CI) {
	...
	else if($mainclass=="successjournal")
	{
		$viewVars['success']=true;
	}
	else if($mainclass=="fatlosscoach")
	{
		$viewVars['fatloss']=true;
	}
